# ColdBuddy - a temperature/humidity monitor built on top of arduino [![Continuous Integration](https://travis-ci.org/rscarvalho/ColdBuddy.svg?branch=master)](https://travis-ci.org/rscarvalho/ColdBuddy)
